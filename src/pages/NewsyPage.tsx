  ...
  <div className="space-y-8">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      <article className="space-y-4">
        <h3 className="font-serif text-2xl font-bold text-card-foreground">Pierwsze wydanie!</h3>
      ...
      <div className="rounded-lg overflow-hidden border-2 border-newspaper-border">
    ...
    <article className="bg-card rounded-lg border border-border p-6 space-y-3">
    ...
    <article className="bg-card rounded-lg border border-border p-6 space-y-3">
      <h3 className="font-serif text-xl font-bold text-card-foreground">🏛️ 81. rocznica walk o Kołobrzeg</h3>
      <p className="text-foreground">
    ...
    <article className="bg-card rounded-lg border border-border p-6 space-y-3">
      <h3 className="font-serif text-xl font-bold text-card-foreground">🎬 Ciekawostka</h3>
      <p className="text-foreground">
