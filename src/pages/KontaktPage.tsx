...
const KontaktPage = () => (
  <div className="space-y-8 max-w-2xl mx-auto">
    ...
    <div className="bg-card border-2 border-primary rounded-lg p-8 text-center space-y-6">
      ...
      <h3 className="font-serif text-2xl font-bold text-card-foreground">Napisz do nas!</h3>
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-bold text-lg hover:opacity-90 transition-opacity"
      >
